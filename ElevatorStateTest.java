...
public abstract class ElevatorStateTest {
    ...
    public void testHandleElevatorButtonPressed() {
        ...
        Event<ElevatorEventType> testEvent = contextBuffer.getEvent(); // get the actual event from the context buffer

        assertEquals(ElevatorEventType.ELEVATOR_BUTTON_PRESSED, testEvent.getEventType()); // check the event type
