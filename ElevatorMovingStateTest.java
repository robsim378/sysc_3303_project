...
public class ElevatorMovingStateTest extends ElevatorStateTest{
    ...
    public void testTravelThroughFloorsTimerEvent() {
        ...
        Event<ElevatorEventType> testEvent = testContext.getOutputBuffer().getEvent();
        ...
        testEvent = contextBuffer.getEvent();
        assertEquals(ElevatorEventType.DIRECTIONAL_LAMP_STATUS_CHANGE, testEvent.getEventType());
